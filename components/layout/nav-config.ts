...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Presupuestos", href: "/presupuestos", icon: FileSpreadsheet, ready: true, tanda: 19, roles: ["owner", "dentista", "recepcionista", "asistente"] },
  { label: "Comunicaciones", href: "/comunicaciones", icon: MessageSquare, ready: true, tanda: 20, roles: ["owner", "recepcionista", "dentista"] },
