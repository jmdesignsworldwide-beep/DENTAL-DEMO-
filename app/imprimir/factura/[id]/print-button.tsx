...
export function PrintBar({ invoiceId }: { invoiceId: string }) {
  React.useEffect(() => {
  ...
  return (
    <div className="mx-auto mb-6 flex max-w-2xl items-center justify-between print:hidden">
      <Link href={`/facturacion/${invoiceId}`} className="inline-flex items-center gap-1.5 text-sm font-semibold text-muted hover:text-fg">
